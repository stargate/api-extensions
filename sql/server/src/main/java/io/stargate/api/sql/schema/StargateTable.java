...
public abstract class StargateTable extends AbstractTable {
  ...
  public static StargateTable from(Keyspace ks, Table t) {
    return ImmutableStargateTable.builder().keyspace(ks).table(t).build();
  }
}
