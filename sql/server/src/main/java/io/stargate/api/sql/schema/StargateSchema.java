...
public abstract class StargateSchema implements Schema {
  public abstract String name();

  public abstract Set<StargateTable> tables();
  ...
  public Set<String> getTableNames() {
    return tables().stream().map(StargateTable::name).collect(Collectors.toSet());
  }
