...
public class StargateStatement extends Meta.StatementHandle {
  private static final QueryPlanner queryPlanner = new QueryPlanner();

  private final Prepared prepared;
  private final DataStore dataStore;

  private StargateStatement(String connectionId, int id, Prepared prepared, DataStore dataStore) {
    super(connectionId, id, prepared.signature());
    this.prepared = prepared;
    this.dataStore = dataStore;
  }

  public static StargateStatement prepare(
      String connectionId, int id, String sql, DataStore dataStore) {
    return new StargateStatement(connectionId, id, prepare(sql, dataStore), dataStore);
  }

  public static StargateStatement empty(String connectionId, int id, DataStore dataStore) {
    return new StargateStatement(connectionId, id, new Prepared(null, null), dataStore);
  }
