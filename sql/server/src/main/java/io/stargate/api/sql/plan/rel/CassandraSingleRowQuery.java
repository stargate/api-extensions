...
public class CassandraSingleRowQuery extends TableScan implements EnumerableRel {

  private final List<Condition> conditions;

  private CassandraSingleRowQuery(
  ...
  public static CassandraSingleRowQuery create(
    ...
    return new CassandraSingleRowQuery(cluster, traitSet, relOptTable, elementType, conditions);
  }
