...
public class CassandraFullScan extends TableScan implements EnumerableRel {
  private CassandraFullScan(
  ...
  public static CassandraFullScan create(RelOptCluster cluster, RelOptTable relOptTable) {
    ...
    return new CassandraFullScan(cluster, traitSet, relOptTable, elementType);
  }
  ...
  public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
    StargateTable backingTable = table.unwrap(StargateTable.class);
